package br.com.cesar.maestroAnalytics.api.config;
...
import br.com.cesar.maestroAnalytics.api.config.token.CustomTokenEnhancer;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter{
	...
	public JwtAccessTokenConverter accessTokenConverter() {
		...
		acessTokenConverter.setSigningKey("plb");
